                        ...
                        title: Padding(
                          ...
                          child: Column(
                            children: [
                              Row(
                                children: [
                                  Text("group_member_name:  "),
                                  group['group_member_name'] != null ? Text(group['group_member_name'])
                                  :Text("null"),
                                ],
                              ),
                              Row(
                                children: [
                                  Text("group_member_type:  "),
                                  group['group_member_type'] != null ? Text(group['group_member_type'])
                                  :Text("null"),
                                ],
                              ),
                              Row(
                                children: [
                                  Text("board_name:  "),
                                  group['board_name'] != null ? Text(group['board_name'])
                                  :Text("null"),
                                ],
                              ),
                              Row(
                                children: [
                                  Text("group_member_turn_over_late:  "),
                                  Text(group['group_member_turn_over_late'].toString()),
                                ],
                              ),
                              Row(
                                children: [
                                  Text("group_member_point_invite:  "),
                                  Text(group['group_member_point_invite'].toString()),
                                ],
                              ),
                              Row(
                                children: [
                                  Text("group_member_point_shere:  "),
                                  Text(group['group_member_point_shere'].toString()),
                                ],
                              ),
                              Row(
                                children: [
                                  Text("point_register:  "),
                                  Text(group['point_register'].toString()),
                                ],
                              ),
                              Row(
                                children: [
                                  Text("tranfer_point_limit:  "),
                                  Text(group['tranfer_point_limit'].toString()),
                                ],
                              ),
                            ],
                          ),
